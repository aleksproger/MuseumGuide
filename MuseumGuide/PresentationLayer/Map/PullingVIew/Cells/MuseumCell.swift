...
extension MuseumCell {
    ...
    static func makeDefaultInfos() -> [InfoTableViewCellModel] {
        return [
            InfoTableViewCellModel.info(MuseumCell.Info(title: "Circle",
            ...
            InfoTableViewCellModel.info(MuseumCell.Info(title: "Triangle",
                            subtitle: "A triangle is a polygon with three edges and three vertices. It is one of the basic shapes in geometry.")),
            
            InfoTableViewCellModel.info(MuseumCell.Info(title: "Square",
